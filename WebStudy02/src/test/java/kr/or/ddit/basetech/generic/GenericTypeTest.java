...
class GenericTypeTest {
	...
	@Test
	void test1() {
		SampleHouse<Child, Parent> house = new SampleHouse<>();	// 다이아몬드(생략가능), house인스턴스 생성, 제너릭 타입 존재
	...
	@Test
	void test2() {
		ExtendedHouse house = new ExtendedHouse();	// house 인스턴스 생성
		Parent p = house.casting2(Parent.class);	// 같은 casting2메소드지만 호출타입이 다름 -> 메소드 호출할 때 정해짐
