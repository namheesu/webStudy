...
public class FormProcessServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		Enumeration<String> paramNames = req.getParameterNames();	// 파라미터의 이름들을 반복적으로 얻기 위해 가져옴
		Map<String, String[]> paramterMap = req.getParameterMap();	// 이름,값 쌍의 형태로 map에 담음, 파라미터의 이름이 key가 되고, value는 string배열 형태로 맵에 저장
