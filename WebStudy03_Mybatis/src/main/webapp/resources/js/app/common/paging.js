 ...
 * 목록 조회(페이징)처리에 공통 적용할 모듈.
	...
	3. data-pg 라는 접두어로 시작되는 데이터 속성을 기반으로 셀렉팅함.
		data-pg-role : pageLink(페이지 네비게이션 a 태그), searchUI(검색조건 입력UI), searchBtn(검색 버튼)
...
$("[data-pg-role='searchUI']").on("click", '[data-pg-role="searchBtn"]', function(){	// 버블링으로 중간셀렉터 사용
...
$("a[data-pg-role='pageLink']").on("click", function(){
